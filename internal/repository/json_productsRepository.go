...
// func (r *jsonrepository) GetAll() ([]Produto, error) {
...
// func (r *jsonrepository) Get(id int) (Produto, error) {
// 	if err := r.db.Read(&ps); err != nil {
// 		return Produto{}, err
// 	}
...
// func (r *jsonrepository) Salvar(id int, nome, cor string, preco float64, estoque int, codigo string, publicacao bool, dataCriacao string) (Produto, error) {
...
// func (r *jsonrepository) Update(id int, nome, cor string, preco float64, estoque int, codigo string, publicacao bool, dataCriacao string) (Produto, error) {
...
// func (r *jsonrepository) UpdateNome(id int, nome string) (Produto, error) {
// 	//Aqui usamos a store para fazermos a leitura do array de produtos
// 	if err := r.db.Read(&ps); err != nil {
// 		return Produto{}, err
// 	}
...
// func (r *jsonrepository) UpdatePreco(id int, preco float64) (Produto, error) {
// 	//Aqui usamos a store para fazermos a leitura do array de produtos
// 	if err := r.db.Read(&ps); err != nil {
// 		return Produto{}, err
// 	}
